...
CREATE TABLE `car` (
  ...
  `carmaster` varchar(36) DEFAULT NULL,
  `price` decimal(10,0) DEFAULT NULL,
  `enginenum` varchar(36) DEFAULT NULL,
...
INSERT INTO `menu` VALUES ('2', '/', '/home', 'Home', '基础功能', 'fa fa-user-circle-o', null, '1', '1', '1');
INSERT INTO `menu` VALUES ('3', '/', '/home', 'Home', '人事管理', 'fa fa-address-card-o', null, '1', '1', '0');
...
INSERT INTO `menu` VALUES ('7', '/employee/basic/**', '/emp/basic', 'EmpBasic', '员工信息', null, null, '1', '2', '1');
